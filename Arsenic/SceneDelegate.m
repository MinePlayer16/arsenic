...
- (void)showSignalGroupNoticeIfNeeded {
    ...
    if (!root) return;
    NSString *msg = @"Created a Signal group as the main place for Arsenic feedback and support.\n\nUse it to report bugs, request features, share test results, ask setup questions, and get notes about new builds.";
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Join the Arsenic Signal Group"
                                                                   message:msg
