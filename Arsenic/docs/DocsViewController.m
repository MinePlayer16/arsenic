...
- (void)buildSections
{
    ...
    NSString *portingNotes =
        ...
        @"\n"
        @"%new -[X arsenicOverlay]             associated object via\n"
        @"                                     objc_setAssociatedObject\n"
    ...
    self.sections = @[
        @{ @"title": @"How tweaks work",
           ...
           @"footer": @"Read sbcustomizer.m, statbar.m, rssidisplay.m, and axonlite.m in "
                      @"Arsenic/tweaks/ for shipped patterns at increasing complexity.",
           @"rows": @[
               @{ @"kind": @"prose",
                  @"text": @"Arsenic tweaks are app-side drivers. No SpringBoard dylibs, no "
        ...
        @{ @"title": @"A minimal tweak",
           ...
           @"footer": @"Drop both files in Arsenic/tweaks/. The Xcode project uses "
           ...
           @"rows": @[
               @{ @"kind": @"prose",
                  @"text": @"Build with ./scripts/build.sh — the IPA is packaged under "
                           ...
                           @"PR." },
               @{ @"kind": @"prose",
                  @"text": @"Source and issues: https://github.com/MinePlayer16/arsenic" },
           ]},
    ];
}
