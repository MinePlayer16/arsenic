<p align="center">
  <img src="https://raw.githubusercontent.com/MinePlayer16/arsenic/main/Arsenic/Assets.xcassets/AppIcon.appiconset/icon-ios-1024x1024.png" alt="Arsenic" width="160">
</p>

<h1 align="center">Arsenic</h1>

**Arsenic** is a fork of the original [Cyanide](https://github.com/0xjohnnydev/cyanide) project by [@0xjohnnydev](https://github.com/0xjohnnydev). It is an iOS tweak runner built on top of the DarkSword kernel r/w primitive.

This fork focuses on updating my existing tweaks and add new ones.

## What's new in Arsenic
* **QuickLoader has been Upgraded:** (check release-notes for details)
...
Add this repository to your sideloading app to get automatic updates:

<p align="center">
  <a href="https://celloserenity.github.io/altdirect/?url=https://raw.githubusercontent.com/MinePlayer16/Arsenic/main/source.json" target="_blank">
    <img src="https://github.com/CelloSerenity/altdirect/blob/main/assets/png/AltSource_Blue.png?raw=true" alt="Add AltSource" width="200">
  </a>
  <a href="https://github.com/MinePlayer16/Arsenic/releases/latest" target="_blank">
...
- [Report a bug](https://github.com/MinePlayer16/arsenic/issues/new?template=bug_report.yml)
- [Request a feature](https://github.com/MinePlayer16/arsenic/issues/new?template=feature_request.yml)
...
- **FastLockX Lite**: keeps Face ID retry/unlock requests armed through
  SpringBoard timers so pickup-to-unlock can work after Arsenic closes.
- **Arsenic Themer**: per-bundle icon theme engine. Walks SpringBoard's
...
- **SnowBoard Lite**: imports SnowBoard/IconBundles-style theme folders or
  archives into Arsenic's local theme library, then applies the selected theme
  through the existing icon replacement pipeline. Ported from
  [`d1y/cyanide-ios`](https://github.com/d1y/cyanide-ios).
- **LiveWP**: copies a selected MP4/MOV/M4V into Arsenic's app container and
...
- **Call Recording Sound**: replaces the CallServices
  `StartDisclosureWithTone` and `StopDisclosure` audio files with Arsenic's
  bundled silent payloads, with separate Silence and Restore actions. Arsenic
  ...
  restore the originals before removing Arsenic if you want Arsenic's backups
...
- [`wh1te4ever`](https://github.com/wh1te4ever): [`kfun` / `darksword-kexploit-fun`](https://github.com/wh1te4ever/darksword-kexploit-fun) — the RemoteCall implementation that lets a sideloaded app apply tweaks inside SpringBoard. Cyanide is a fork of this project and Arsenic is a fork of Cyanide.
...
- [`LacertosusDeus`](https://github.com/LacertosusRepo): [Speculum](https://repo.packix.com/package/com.lacertosusrepo.speculum) — Lockscreen customization reimplemented using RemoteCall.

### UI inspiration

- The classic [Installer.app](https://github.com/AppTapp/Installer-3) (Ripdev & Nullriver Software, now maintained by AppTapp and the Legacy Jailbreak community) — the iPhoneOS 1 package-manager look that the Arsenic Installer tab is modeled after.
...
The build script uses the `Arsenic` scheme, disables code signing, and writes
an unsigned IPA to:
...
Arsenic includes two JavaScript tweak runners contributed by Iggy05:
...
- **RepoTweaks Store** imports HTTPS JSON repositories and downloads selected
  JavaScript tweaks from those sources. Arsenic seeds the zeroxjf source at
  `https://0xjohnnydev.github.io/cyanide-repotweaks.json` by default.

Only run scripts and repositories you trust; JavaScript tweaks can call Arsenic
