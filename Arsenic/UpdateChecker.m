...
static NSString * const kReleasesAPI             = @"https://api.github.com/repos/MinePlayer16/arsenic/releases/latest";
                         ...
                         notes:(NSString *)notes
{
    ...
    [message appendFormat:@"A new release of Arsenic is available.\n\nLatest: %@\nInstalled: %@",
                          latest, current];
