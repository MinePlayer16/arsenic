    ...
    for (NSString *url in catalog_repotweaks_urls(d)) {
        ...
        for (id tweakRaw in (NSArray *)tweaksRaw) {
            ...
            if (unsupportedReason.length > 0) {
                ...
                pkg.installDisabledReason = @"This repo tweak needs a dedicated Arsenic native backend before it can install.";
            }
    ...
    dispatch_once(&once, ^{
        ...
        Package *axon = [[Package alloc] initWithIdentifier:@"com.darksword.axonlite"
                               ...
                               shortDescription:@"Group Notification Center requests by app"
                                longDescription:@"Groups visible Notification Center requests by app in a SpringBoard overlay and filters duplicates while Arsenic keeps the RemoteCall session alive.\n\nNo extra configuration."
                                        version:version
                                         author:@"zeroxjf"
                                     ...
                                     enabledKey:kSettingsAxonLiteEnabled
                                          isNew:NO];
        axon.unstableWarning = @"⚠️ Experimental: work-in-progress. Expect SpringBoard crashes, dropped notifications, layout glitches, and breakage between Arsenic builds. Don't rely on it for anything important.";
        ...
        Package *notificationIsland = [[Package alloc] initWithIdentifier:@"com.darksword.notificationisland"
                               ...
                               shortDescription:@"Mirror incoming banners into the Dynamic Island"
                                longDescription:@"Experimental Dynamic Island notification route. Watches SpringBoard's active banner request over the shared RemoteCall session, then mirrors the title/body into Arsenic's ActivityKit Live Activity.\n\nNo extra configuration."
                                        version:version
                                         author:@"zeroxjf"
                                       category:@"In Development"
        ...
        Package *stageStrip = [[Package alloc] initWithIdentifier:@"com.darksword.stagestrip"
            ...
            @"• Gear in the picker tray jumps back to Arsenic settings.\n\n"
        ...
        Package *snowboardLite = [[Package alloc] initWithIdentifier:@"com.darksword.snowboardlite"
                               ...
                               shortDescription:@"Local SnowBoard-style icon themes"
                                longDescription:@"Imports SnowBoard/IconBundles themes into a local library and applies the selected theme through Arsenic's icon replacement pipeline. Supports the bundled iOS 6 theme and local folder imports.\n\nSnowBoard Lite is the main icon-theme entry point in Arsenic.\n\nPorted from d1y/cyanide-ios."
                                        version:version
                                         author:@"d1y"
                                       category:@"Theming"
        ...
        Package *liveWP = [[Package alloc] initWithIdentifier:@"com.darksword.livewp"
                               ...
                               shortDescription:@"Video wallpaper for Home and Lock Screen"
                                longDescription:@"Plays a selected MP4/MOV/M4V video behind SpringBoard's home and lock screen windows while Arsenic keeps the RemoteCall session alive.\n\nPorted from d1y/cyanide-ios."
                                        version:version
                                         author:@"d1y"
                                       category:@"Theming"
        ...
        gravityLite.knownIssues = @[
            @"To disable, use the App Switcher to return to Arsenic and deactivate Gravity Lite. There is no other way to stop it right now.",
            @"Touch input does not register on displaced icons yet. Forwarding taps in this environment is a major WIP.",
            @"Install is slow as hell. WIP. Arsenic has to capture every visible icon and widget before physics start.",
        ...
        Package *quickLoader = [[Package alloc] initWithIdentifier:@"com.darksword.quickloader"
                               ...
                               shortDescription:@"Executes custom .js code"
                                longDescription:@"Select a local JavaScript file from Files, configure any declared parameters, and run it through Arsenic's SpringBoard RemoteCall bridge.\n\nOnly run scripts you trust. JavaScript tweaks can send private SpringBoard messages and destabilize the device if the script is buggy."
                                        version:@"2.0"
                                         author:@"Iggy05"
                                       category:@"SpringBoard"
        ...
        quickLoader.unstableWarning = @"Runs user-selected JavaScript with access to Arsenic's RemoteCall helpers. Only use scripts you trust; bad scripts can crash SpringBoard.";

        Package *magsafe = [[Package alloc] initWithIdentifier:@"com.darksword.magsafe"
                                           name:@"Magsafe Enabler"
                               shortDescription:@"Fake MagSafe charging animation"
                                longDescription:@"Displays a native-looking MagSafe charging ring animation directly on SpringBoard when you plug in your device.\n\nStartup may take some time due to caching.\n\nToggle the tweak from the Settings tab."
                                        version:@"1.0"
                                         author:@"Iggy05"
                                       category:@"SpringBoard"
        ...
        magsafe.unstableWarning = @"⚠️ Experimental: Currently it forces the native magsafe animation, support for other animations is WIP";

        Package *notweafications = [[Package alloc] initWithIdentifier:@"com.darksword.notweafications"
                                           name:@"Notweafications"
                               shortDescription:@"Remote-Call live notification coloring"
                                longDescription:@"Colors lockscreen and notification center cells based on their app bundle identifier using a live app-side loop.\n\nToggle the tweak from the Settings tab."
                                        version:@"2.0"
                                         author:@"Iggy05"
                                       category:@"SpringBoard"
                                     symbolName:@"paintpalette.fill"
                                           kind:PackageInstallKindToggle
                                     enabledKey:kSettingsNotweaficationsEnabled
                                          isNew:YES];
        notweafications.settingsSection = kSecNotweafications;
        notweafications.unstableWarning = @"⚠️ Experimental: work-in-progress. Expect color glitches and breakage between Arsenic builds. Don't rely on it for anything important.";

        Package *speculumLite = [[Package alloc] initWithIdentifier:@"com.arsenic.speculumlite"
                                           name:@"Speculum Lite"
        ...
        nanoRegistry.unstableWarning = @"Warning: modifies a local NanoRegistry MobileAsset. Arsenic saves a .arsenic.bak backup beside the original, but system-file edits can fail or require a respring/reboot. Apply or remove this override at your own risk.";
        ...
        Package *callRecordingSound = [[Package alloc] initWithIdentifier:@"com.darksword.callrecording-sound"
                               ...
                               shortDescription:@"Silence disclosure start/stop sounds"
                                longDescription:@"Replaces the CallServices StartDisclosureWithTone and StopDisclosure audio files with Arsenic's bundled silent payloads.\n\nCredits: YangJiiii (@duongduong0908) for the EnsWilde and Disable Call Recording BookRestore reference tools. @Little_34306 is credited by the original projects for the Disable Call Recording concept. Arsenic port, KRW-backed implementation, and generated replacement silent audio assets by zeroxjf.\n\nSystem-file warning: this modifies files under /var/mobile/Library/CallServices/Greetings/default. Arsenic backs up the first originals into its app container, but system file replacement can fail, partially apply, or require a respring/reboot to settle.\n\nLegal note: call-recording disclosure sounds may exist to satisfy consent, notification, or privacy-law requirements in some places. You are responsible for understanding and following the laws that apply to you.\n\nThis port does not use the old Books/BookRestore/sparserestore path. Arsenic runs KRW, unlocks local /private/var write access, then writes directly to the CallServices files.\n\nUse Restore Original Sounds to write Arsenic's backups back when present. You apply or restore this tweak at your own risk."
                                        version:version
        ...
        callRecordingSound.unstableWarning = @"Beta: persistent CallServices system-file replacement. Disclosure sounds may be legally required where you live; you are responsible for your use and apply this at your own risk. Use Restore Original Sounds before removing Arsenic if you want Arsenic's backups written back.";
        ...
        Package *hideHomeBar = [[Package alloc] initWithIdentifier:@"com.darksword.hide-home-bar"
                               ...
                               shortDescription:@"Hide the bottom home indicator"
                                longDescription:@"Zeros the first page of /System/Library/PrivateFrameworks/MaterialKit.framework/Assets.car using Arsenic's stable file-page zero path, which hides the bottom home indicator after SpringBoard reloads assets.\n\nRun Hide Home Bar by itself, then respring so SpringBoard refreshes the asset cache. To bring the home indicator back, choose Restore Home Bar and respring again. Other live SpringBoard tweaks, such as App Switcher Grid, should be applied in a separate run after the respring.\n\nCredits: C4ndyF1sh/ZeroCalories for the Home Bar target and jailbreakdotparty/dirtyZero for the original page-zeroing idea. Arsenic port by zeroxjf."
                                        version:version
