//
//  ipadecryptor.m
//  Arsenic private/in-dev IPA decryptor scaffold.
//
...
static NSString * const kIPAAccountEmailKey = @"arsenic.ipadecryptor.apple.email";
static NSString * const kIPAAccountTokenKey = @"arsenic.ipadecryptor.apple.passwordToken";
static NSString * const kIPAAccountDSIDKey = @"arsenic.ipadecryptor.apple.dsid";
static NSString * const kIPAAccountStoreFrontKey = @"arsenic.ipadecryptor.apple.storeFront";
static NSString * const kIPAAccountPodKey = @"arsenic.ipadecryptor.apple.pod";
static NSString * const kIPAAccountNameKey = @"arsenic.ipadecryptor.apple.name";
static NSString * const kIPAGUIDKey = @"arsenic.ipadecryptor.apple.guid";
                                                                           ...
                                                                           NSString **messageOut)
{
    ...
    [request setValue:@"Arsenic IPADecryptor/0.1" forHTTPHeaderField:@"User-Agent"];
